...
| --------------------------------------------------------------- | ----------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------- |
| Assembly                                                        | Medium                                                | 🟥       | Not sure where this one is going, or what kind of assembly is covered                                          |
...
| CodeIgniter (PHP)                                               | Medium/High                                           | 🟥       | Need to start it                                                                                               |
| Computing and the Cloud (COMP3370)                              | High                                                  | 🟩       | Includes everything inside the University of Kent lectures, but not everything in cloud computing more broadly |
...
| jQuery                                                          | High                                                  | 🟨       | Needs to be more refined.                                                                                      |
...
| Python Keras                                                    | High                                                  | 🟨       | Only contains the basics currently                                                                             |
| Python Scikit-Learn                                             | High                                                  | 🟨       | Need to add more content to it                                                                                 |
...
| SQL                                                             | Medium                                                | 🟩       | It's got pretty much everything there to get started.                                                          |
